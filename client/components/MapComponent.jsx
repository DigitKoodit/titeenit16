  ...
  componentDidMount() {
    ...
    GoogleMaps.ready(this.props.name, function(map) {
      var locations = [
        ...
        ['Pesäpallokenttä', 'https://goo.gl/maps/mrbQ6AvCzT32', 60.446205, 22.297271, 'Lauantaina <ul><li>Curling 17:00</li></ul>', 1],
        ['Kupittaan puisto', 'https://goo.gl/maps/NopxPrpHTnS2', 60.445732, 22.287388, 'Lauantaina <ul><li>Aamupala 10:00</li> <li>VVN-peli 11:00</li> <li>Joystiq 15:00</li></ul>', 1],
